...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/user/add").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers("/user/edit").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers("/user/delete/*").hasAnyAuthority("ROLE_ADMIN")
                .antMatchers("/user/details/*").hasAnyAuthority("ROLE_ADMIN","ROLE_PROFESSOR")
                .antMatchers("/user/**").hasAnyAuthority("ROLE_STUDENT", "ROLE_PROFESSOR", "ROLE_ADMIN")
